...
export default function DashboardClient() {
 ...
 <GlassCard className="p-8 group cursor-pointer relative overflow-hidden hover:scale-[1.01] h-full">
 <div className="flex items-center gap-6">
 <div className={`w-16 h-16 rounded-2xl flex items-center justify-center ${isLight ? "bg-black/5 border border-black/10 text-black group-hover:text-black" : "bg-white/5 border border-white/10 text-white group-hover:text-white"} `}>
 <LayoutDashboard className="w-8 h-8" />
 </div>
 <div>
 <h3 className="text-2xl tracking-tighter">{t('txt_cbfd59')}</h3>
 ...
 <div>
 <div className="text-sm ">{t('txt_8f0aa2')}</div>
 <div className="text-[11px] text-white uppercase tracking-widest">{currentProfile.email}</div>
 </div>
 </div>
 <Button
 variant="ghost"
 ...
 <div>
 <div className="text-sm ">{t('txt_913aff')}</div>
 <div className="text-[11px] text-white uppercase tracking-widest">
