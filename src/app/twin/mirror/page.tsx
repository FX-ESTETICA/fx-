    ...
    <div className="relative w-full h-screen bg-[#050505] overflow-hidden text-white font-sans flex flex-col">
      ...
      <div className="absolute top-0 w-full p-6 flex justify-between items-center z-50 pointer-events-none">
        ...
        <button 
          ...
          className="flex items-center gap-2 text-xs uppercase tracking-[0.2em]  transition-colors pointer-events-auto"
        >
      ...
      <div className="absolute bottom-10 w-full flex justify-center z-50 pointer-events-none">
        ...
        >
          ...
          >
            ...
            <span className="text-[9px] uppercase tracking-[0.2em]">Skin</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] uppercase tracking-[0.2em]">Hair</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] uppercase tracking-[0.2em]">Wardrobe</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] uppercase tracking-[0.2em]">Actions</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] uppercase tracking-[0.2em]">Bikini</span>
          </button>
              ...
              {activeMenu === 'wardrobe' && (
                <div className="space-y-4">
                  ...
                  {generatedGarments.length > 0 && (
                    <div className="space-y-2">
                      <p className="text-[10px]  uppercase tracking-widest px-1">Generated Assets</p>
                  ...
                  {!isGenerating ? (
                    <button 
                      ...
                      className="relative w-full overflow-hidden group p-4 rounded-xl border  bg-gradient-to-br  to-transparent  transition-all flex flex-col items-center justify-center gap-2"
                    >
                      <div className="absolute inset-0  transition-colors" />
                      <Sparkles className="w-5 h-5  mb-1" />
                      <span className="text-xs  font-medium tracking-wide z-10">AI Garment Engine</span>
                      <span className="text-[9px]  z-10 text-center">Upload photo to generate<br/>3D physics-ready mesh</span>
                    </button>
                  ) : (
                    <div className="w-full p-4 rounded-xl border   flex flex-col gap-3 relative overflow-hidden">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px]  tracking-wider">GPU NODE ACTIVE</span>
                      </div>
                    ...
                    <div className="flex flex-wrap gap-2 justify-end">
                      {["#1a1a1a", "#ef4444", "#3b82f6", "#10b981", "#f59e0b", "#8b5cf6", "#ec4899", "#f87171", "#ffffff"].map(c => (
                        <button
                          ...
                          className={`w-6 h-6 rounded-full border border-white/20 transition-all ${braColor === c ? 'ring-2 ring-white scale-110' : 'hover:scale-105'}`}
                    ...
                    <div className="flex flex-wrap gap-2 justify-end">
                      {["#1a1a1a", "#ef4444", "#3b82f6", "#10b981", "#f59e0b", "#8b5cf6", "#ec4899", "#f87171", "#ffffff"].map(c => (
                        <button
                          ...
                          className={`w-6 h-6 rounded-full border border-white/20 transition-all ${pantiesColor === c ? 'ring-2 ring-white scale-110' : 'hover:scale-105'}`}
                          style={{ backgroundColor: c }}
                        />
                      ))}
                    </div>
