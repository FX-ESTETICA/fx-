...
export default function OnboardingPage() {
 ...
 <button 
 onClick={() => router.back()}
 className="flex items-center gap-2 text-white mb-12 group"
 >
 <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 " />
 <span className="text-xs uppercase tracking-widest">{t('txt_7513ca')}</span>
 </button>
 ...
 <span className="text-[11px] uppercase tracking-[0.2em]">{t('txt_5eb15b')}</span>
 </motion.div>
 ...
 >
 <GlassCard className="h-full p-8 border-white/5 space-y-4 group ">
 ...
 className="w-full md:w-auto px-12 py-5 text-black uppercase tracking-widest rounded-2xl hover:scale-105 flex items-center justify-center gap-3"
 prefetch={false}
 >
 ...
 <span className="text-[11px] uppercase tracking-[0.3em]">{t('txt_f1bdcd')}</span>
 <div className="w-12 h-px bg-white/10" />
 </div>
 </motion.div>
 </div>
