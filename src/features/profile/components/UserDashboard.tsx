        ...
        >
          ...
          <div className="hidden sm:flex w-2/5 relative p-10 flex-col justify-between border-r border-white/5 bg-gradient-to-b from-gx-gold/5 to-transparent">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl font-black tracking-tighter mb-4 leading-tight">
                {t('txt_d3a60f')}<br/>{t('txt_697bfe')}</h2>
          ...
          <div className="flex-1 p-6 sm:p-10 flex flex-col h-full overflow-y-auto custom-scrollbar max-h-[85vh]">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-xl font-bold tracking-tighter">{t('txt_76a4ee')}</h3>
            ...
            <div className="space-y-6 flex-1">
              ...
              <div className="space-y-4">
                <h4 className="text-[10px] font-bold text-white/60 uppercase tracking-widest border-b border-white/5 pb-2">{t('txt_2c1fcd')}</h4>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 relative">
                    <label className="text-[10px] text-white/40 uppercase font-mono sm:w-36 shrink-0">{t('txt_7b7c43')}</label>
                ...
                {ascensionMode === "indie" && (
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 relative">
                    <label className="text-[10px] text-white/40 uppercase font-mono sm:w-36 shrink-0">{t('txt_133313')}</label>
              ...
              {ascensionMode === "indie" && (
                <div className="space-y-4">
                  <h4 className="text-[10px] font-bold text-white/60 uppercase tracking-widest border-b border-white/5 pb-2">{t('txt_99ebed')}</h4>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 relative">
                    ...
                    <div className="relative z-20 flex-1">
                      ...
                      />
                      <p className="text-[9px] text-white/30 mt-2">{t('txt_bd30a5')}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-white/10 rounded-xl p-8 flex flex-col items-center justify-center gap-3 bg-white/[0.02] hover:bg-white/[0.04] transition-colors cursor-pointer group">
                  ...
                  <div className="text-center">
                    <p className="text-sm font-bold">{t('txt_288d4b')}</p>
                    <p className="text-[10px] text-white/40 mt-1">{t('txt_89e530')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-white/5">
                <h4 className="text-[10px] font-bold text-gx-gold uppercase tracking-widest flex items-center gap-2">
                  <Zap className="w-3 h-3" /> {t('txt_1c0987')}{ascensionMode === "indie" ? <span className="text-white/40">- OPTIONAL</span> : <span className="text-gx-gold/60">- AUTO GENERATED</span>}
                </h4>
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 relative">
                  <label className="text-[10px] text-white/40 uppercase font-mono sm:w-36 shrink-0">{t('txt_047e19')}</label>
                  <div className="relative z-20 flex-1">
                    {ascensionMode === "enterprise" ? (
                      <div className="bg-black/50 p-3 rounded-lg border border-gx-gold/30 font-mono text-gx-gold flex items-center justify-between">
                        ...
                        <span className="text-[10px] text-gx-gold/40 border border-gx-gold/20 px-2 py-0.5 rounded">{t('txt_715ff0')}</span>
                      </div>
                    ) : (
                      <Input 
                    ...
                    <p className="text-[9px] text-white/30 leading-relaxed mt-2">
                      {ascensionMode === "enterprise" 
                        ...
                        : <>{t('txt_816c34')}<br/><span className="text-gx-gold/60">{t('txt_a86a3c')}</span></>
                      }
                    </p>
                  </div>
                </div>
        ...
        {applicationStatus === "success" ? (
          ...
          <div className="relative overflow-hidden rounded-xl border border-white/20 bg-black/20 backdrop-blur-sm transition-all duration-700 p-6 flex items-center justify-between shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-[12px] font-bold tracking-widest uppercase text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">{t('txt_060153')}</h3>
          ...
          <div className="relative overflow-hidden rounded-xl border border-gx-red/30 bg-black/20 backdrop-blur-sm transition-all duration-700 p-6 flex items-center gap-4 shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
             <div className="w-8 h-8 rounded-full border border-gx-red/40 flex items-center justify-center bg-gx-red/10">
              ...
              <div>
                <h3 className="text-[12px] font-bold tracking-widest uppercase text-gx-red drop-shadow-[0_0_5px_rgba(255,0,0,0.5)]">{t('txt_94eb25')}</h3>
                <p className="text-[10px] font-mono text-gray-300 mt-0.5 tracking-widest drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">{t('txt_961427')}</p>
              </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl border border-gx-cyan/30 bg-black/20 backdrop-blur-sm transition-all duration-700 p-6 flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
             <h3 className="text-[12px] font-bold tracking-widest uppercase text-gx-cyan text-center drop-shadow-[0_0_8px_rgba(0,240,255,0.8)]">{t('txt_59c21c')}</h3>
          </div>
        ) : (
          // 初始黄金横幅 (极致镂空 + 黄金渐变)
            ...
            <div className="relative overflow-hidden rounded-xl border border-gx-gold/30 hover:border-gx-gold/60 bg-transparent transition-all duration-700 shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
              ...
              <div className="relative z-10 p-6 flex items-center justify-between gap-4 bg-black/20">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-[13px] font-black tracking-widest uppercase bg-clip-text text-transparent bg-gradient-to-r from-amber-200 via-yellow-400 to-orange-500 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">{t('txt_3db109')}</h3>
