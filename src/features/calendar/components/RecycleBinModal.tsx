              ...
              <div key={b.id} className="flex items-center justify-between p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:border-white/15 transition-all group">
                ...
                <div className="flex items-center gap-3  group-hover:opacity-100 transition-opacity">
                  ...
                  <button 
                    ...
                    className="px-4 py-2 rounded-lg border border-red-500/30 text-red-500 hover:bg-red-500/10 transition-colors text-[10px] font-mono font-bold tracking-widest flex items-center gap-2 "
                  >
