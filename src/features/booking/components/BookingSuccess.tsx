...
export const BookingSuccess = ({ details, onDone }: BookingSuccessProps) => {
 ...
 return (
 <div className="max-w-2xl mx-auto space-y-12 py-12 text-center animate-in fade-in slide-in-from-bottom-8 ">
 ...
 <h2 className="text-4xl tracking-tight">{t('txt_b179be')}</h2>
 ...
 <p className="text-[11px] text-white uppercase tracking-[0.3em]">BOOKING_ID</p>
 ...
 <p className="text-[11px] text-white uppercase tracking-widest flex items-center gap-2">
 ...
 <div className="space-y-4 text-white text-[11px] uppercase tracking-[0.5em]">
