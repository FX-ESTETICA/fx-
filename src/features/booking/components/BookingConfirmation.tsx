      ...
      <GlassCard className="p-8 border-white/10 bg-white/[0.03]" >
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-8 border-b border-white/5">
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] font-mono text-white uppercase tracking-widest mb-1">{t('txt_77480b')}</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] font-mono text-white uppercase tracking-widest mb-1">{t('txt_ac3930')}</p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] font-mono text-white uppercase tracking-widest mb-1">{t('txt_3c116d')}</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] font-mono text-white uppercase tracking-widest mb-1">{t('txt_63fb41')}</p>
          ...
          <div className="space-y-4 py-4">
            <h4 className="text-[10px] font-mono text-white uppercase tracking-widest flex items-center gap-2">
              <User className="w-3 h-3" /> {t('txt_8fa0a1')}</h4>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                <p className="text-[9px] font-mono text-white uppercase tracking-tighter mb-1">{t('txt_60d045')}</p>
                <p className="text-sm">{details.customerName}</p>
              </div>
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                <p className="text-[9px] font-mono text-white uppercase tracking-tighter mb-1">{t('txt_5a93d3')}</p>
                <p className="text-sm font-mono">{details.customerPhone}</p>
              </div>
            </div>
            {details.notes && (
              <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                <p className="text-[9px] font-mono text-white uppercase tracking-tighter mb-1">{t('txt_2432b5')}</p>
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-[11px] text-white group-hover:text-white transition-colors select-none">
                {t('txt_b87e42')}</span>
            </label>
          </div>
