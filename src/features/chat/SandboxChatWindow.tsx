  ...
  return (
    <div className="flex flex-col h-[600px] w-full max-w-md mx-auto bg-black text-white border  rounded-2xl overflow-hidden  relative">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-gradient-to-r  to-black border-b  shrink-0">
        ...
        <span className="text-xs  font-mono">Realtime 0ms</span>
      </div>
      ...
      <div className="p-4  border-t  shrink-0">
        <div className="flex items-end space-x-3 bg-black rounded-xl p-2 border ">
          ...
          {/* 选择图片按钮 (隐藏原生 input) */}
          <label className="cursor-pointer shrink-0 p-2 rounded-lg  transition-colors">
            <input 
              type="file" 
              accept="image/*" 
              className="hidden" 
          ...
          <button 
            ...
            className="shrink-0 p-2   text-white rounded-lg transition-colors flex items-center justify-center"
          >
            {isSending ? (
