...
export const CyberOnboardingModal = () => {
 ...
 <h2 className="text-2xl tracking-tighter text-white mb-2">
 请选择您的使用身份
 </h2>
 ...
 className="group relative p-6 rounded-2xl border border-white/10 bg-black/20 hover:bg-white/5 hover:border-white/30 flex flex-col items-center gap-4 text-center"
 >
 <div className="w-14 h-14 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 ">
 <UserCircle className="w-8 h-8 text-white group-hover:text-white " />
 </div>
 <div>
 <div className=" text-white tracking-widest mb-1 text-lg">生活</div>
 <div className="text-[11px] text-white tracking-wider">预约服务 · 探索周边门店</div>
 </div>
 </button>
 ...
 className="group relative p-6 rounded-2xl border flex flex-col items-center gap-4 text-center"
 >
 <div className="w-14 h-14 rounded-full flex items-center justify-center ">
 <Building2 className="w-8 h-8 " />
 </div>
 <div>
 <div className=" tracking-widest mb-1 text-lg">智控</div>
 <div className="text-[11px] tracking-wider">数字门店 · 智能排班日历</div>
 </div>
 </button>
 </div>
 </motion.div>
 ...
 className="w-10 h-10 rounded-full flex items-center justify-center bg-black/20 border border-white/5 hover:bg-white/10 hover:border-white/20 text-white hover:text-white "
 >
 <ArrowLeft className="w-5 h-5" />
 </button>
 <div className="flex-1">
 <h2 className="text-xl tracking-tighter text-white">
 {roleSelection === 'merchant' ? '创建数字门店' : '填写会员信息'}
 </h2>
 <p className="text-[11px] text-white tracking-widest mt-1">
 ...
 <label className="text-[11px] text-white tracking-widest flex items-center gap-2">
 ...
 className={`h-10 rounded-lg text-xs tracking-widest border ${
 ...
 className="w-full h-12 bg-black/50 text-white border border-white/10 rounded-lg px-2 sm:px-3 text-sm appearance-none focus:outline-none "
 >
 ...
 className="w-full h-12 bg-black/50 text-white border border-white/10 rounded-lg px-3 text-sm appearance-none focus:outline-none "
 >
 ...
 className="w-full h-12 rounded-lg tracking-widest mt-4 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed border "
 >
 ...
 <p className="text-xs text-white tracking-[0.2em] uppercase">
 {t('txt_22fc92')}
 </p>
 </motion.div>
 )}
