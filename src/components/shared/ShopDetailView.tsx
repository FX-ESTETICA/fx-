...
export function ShopDetailView({
  ...
  return (
    <div className={cn("w-full bg-[#0a0a0a] min-h-[100dvh] transition-colors duration-500", !isCompact && "md:pb-24", hideContent && "bg-black pb-0 md:pb-0")}>
      {/* Detail View Hero Image */}
      <div className={cn(
        "w-full bg-white/5 relative transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]", 
        isCompact 
        ...
        {coverImages.length > 0 ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50 border-b border-white/10">
            ...
            <span className="text-white font-mono text-[10px] tracking-widest">{t('txt_36b5f5')}</span>
          </div>
        )}
            ...
            <div className="w-full aspect-[3/4] xl:aspect-[4/5] rounded-3xl bg-[#111] border border-white/10 relative overflow-hidden  group sticky top-8 flex items-center justify-center">
              {coverImages.length > 0 ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50">
                  ...
                  <span className="text-white font-mono text-[10px] tracking-widest">{t('txt_b59359')}</span>
                </div>
              )}
              {/* 画廊顶部光影遮罩 */}
              ...
              {/* SWIPE Badge */}
              <div className="absolute top-6 left-6 px-3 py-1.5 rounded-lg bg-black/40  border border-white/10 text-[10px] font-bold tracking-widest text-white uppercase flex items-center gap-2">
          ...
          <div className="flex items-start justify-between text-xs text-white mb-3">
            <div className="flex items-center gap-2">
              ...
              {hours && hours.length > 0 && (
                <span className="font-mono whitespace-nowrap text-white ml-2">
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <div className="text-[10px] text-white font-mono mt-1.5 flex items-center gap-1.5">
