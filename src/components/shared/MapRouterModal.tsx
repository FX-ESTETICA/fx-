...
export const MapRouterModal = ({ isOpen, onChoice }: MapRouterModalProps) => {
 ...
 <h2 className="text-xl text-white mb-2">{t('txt_4dffc7')}</h2>
 ...
 className="w-full flex items-center justify-between px-4 py-3 border rounded-xl group"
 >
 ...
 className="w-full flex items-center justify-between px-4 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl "
 >
 ...
 <div className={`w-4 h-4 rounded-sm border flex items-center justify-center ${remember ? ' ' : 'border-white/20'}`}>
