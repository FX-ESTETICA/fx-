...
export function PWAUpdater() {
 ...
 return (
 <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[99999] animate-in fade-in slide-in-from-top-4 ">
 <div className="bg-black/70 backdrop-blur-xl border border-white/10 rounded-full px-5 py-2.5 flex items-center gap-3 shadow-2xl">
 <div className="flex items-center gap-2">
 {/* 星云呼吸灯 */}
 <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 shadow-[0_0_8px_#22d3ee]"></div>
 <span className="text-[13px] font-medium text-white tracking-wide whitespace-nowrap">
 星云链路已进化
 </span>
 </div>
 ...
 <button
 onClick={handleSync}
 className="text-[13px] font-semibold text-cyan-300 hover:text-cyan-200 flex items-center gap-1.5 active:scale-95 whitespace-nowrap"
 >
